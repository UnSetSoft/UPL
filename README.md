...
The **UPL 1.0** is a _non-commercial, contribution-based_ open-source license.  
...
The **UPL-CE 1.0** is the _corporate_ version of the license.  
It becomes active when a company subscribes to the paid tier:

> **“Get a company license for my project — $500/month”** (GitHub)
...
### Can I use these licenses in my projects?

# <<<<<<< HEAD

> > > > > > > 638663b (Simplify README by removing introductory content)
> > > > > > > Yes! that's the idea of this repo!

### When should I use UPL and UPL-CE?

UPL-CE is a license specifically usable when you activate the “Support” option in the repository. You must configure a tier that specifies $500 per month and specify that they can use your project commercially. The default is normal UPL; UPL-CE is a complementary variant that overrides the Open Source UPL license to extend it only to businesses. Typical users will continue to use UPL.

As an added bonus, if you don't want to cause confusion, you can create a private repository with only the UPL-CE license and link it to the tier. That way, when a company subscribes monthly, it can access that repository where the license is located.

---

"Modifications to licenses are not permitted unless an issue and a PR are created for discussion."
